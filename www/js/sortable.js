todoApp.directive('sortable', ['$ionicGesture', '$ionicScrollDelegate', function ($ionicGesture, $ionicScrollDelegate) {
    return {
        restrict: 'A',
        scope: {
            draggable: '@',
        ...
        link: function (scope, element, attrs) {
            ...
            $ionicGesture.on('hold', function (e) {
                ...
                categoryId = $(dragging[0]).attr("data-category-id");
                
                taskId = $(dragging[0]).attr("data-task-id");
